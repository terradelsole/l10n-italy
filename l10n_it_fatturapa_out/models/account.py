...
class AccountInvoice(models.Model):
    ...
    def check_DatiGeneraliDocumento(self, new_xml, original_xml):
        ...
        for lr, new_line_ritenuta in enumerate(new_xml.findall(".//DatiGeneraliDocumento/DatiRitenuta")):
    ...
    def check_DatiBeniServizi(self, new_xml, original_xml):
        ...
        for ld, new_line_details in enumerate(new_xml.findall(".//DatiBeniServizi/DettaglioLinee")):
        ...
        for lr, new_line_riepilogo in enumerate(new_xml.findall(".//DatiBeniServizi/DatiRiepilogo")):
